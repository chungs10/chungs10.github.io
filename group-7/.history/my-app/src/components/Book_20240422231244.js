...
function MyBook(props) {
  ...
  // call the allMuseums api to get all the museums and store the data in a state
  ...
  useEffect(() => {
    fetch("./allMuseums")
      ...
      .then(data => {
        console.log(data);
        setMuseums(data);
        // for every museum in the data, create a draggable stamp
        data.forEach((museum) => {
          // add a draggable stamp to the page <Draggable bounds="parent">
          const stamp = document.createElement("Draggable");
          stamp.className = "draggable-stamp";
          stamp.textContent = museum.name;
