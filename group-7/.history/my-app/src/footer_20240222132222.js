        ...
        <div style={{width: '100%', position: 'absolute', bottom: 0, background: '#FDF3DE'}}>
            <div style={{width: 1125.34, height: 112, margin: '0 auto', position: 'relative'}}>
                ...
                <div style={{width: 162.34, height: 112, left: 963, top: 0, position: 'absolute'}}>
                    <div style={{left: 10, top: 78, position: 'absolute', textAlign: 'right', color: '#4B4338', fontSize: 14, fontFamily: 'Kumbh Sans', fontWeight: '400', wordWrap: 'break-word'}}>© Copyright 2024 Museo<br/>All Rights Reserved</div>
