...
function MyBook(props) {
    return (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '85vh', borderRadius: '100px', border: '2px solid #FF0000', background: '#E2D6C0', marginRight: '40px'}}>
